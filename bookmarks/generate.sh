...
$BOOKMARK2MD_HOME/bookmark2md.sh "$BOOKMARK_EXPORTED_FROM_BROWSER_DIRECTORY/$LATEST_BOOKMARK_EXPORTED_FILE" $BOOKMARK_FOLDER_NAME "$GENERATED_FOLDER" "$MARKDOWN_FILE_NAME"  "$HTML_PRETTY_FILE_NAME"  "$RAW_IMPORTABLE_HTML_FILE"
