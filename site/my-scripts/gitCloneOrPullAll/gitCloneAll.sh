...
curl "https://api.github.com/user/repos" --header "Authorization: Bearer $GITHUB_TOKEN" | grep -e 'clone_url*' | cut -d \" -f 4 | sed  "s/https:\/\//https:\/\/$GITHUB_TOKEN@/g" |xargs -L1 git clone
