...
* ## IT
  ...
  * [Víctor Porcar](https://victor-porcar.github.io/)
  * ## Util
    ...
    * [untitled - Paint](https://jspaint.app/#local:46eb9d943c75c)

  * ## My Git

    * ## delayed-batch-executor

      * [victor-porcar/delayed-batch-executor: A component to decrease the number of required queries by batching them in Java multi-threaded applications](https://github.com/victor-porcar/delayed-batch-executor)
      * [Optimizing Data Repositories Usage in Java Multi-Threaded Applications - DZone](https://dzone.com/articles/optimizing-data-repositories-usage-in-java-multith)
      * [DelayedBatchExecutor: How to Optimize Database Usage in Java Multi-Threaded Applications - DZone Java](https://web.archive.org/web/20200815000143/https://dzone.com/articles/delayedbatchexecutor-how-to-optimize-database-usag)

    * [victor-porcar/victor-porcar.github.io](https://github.com/victor-porcar/victor-porcar.github.io)
    * [victor-porcar/TimelapseDNGInterpolator2: This is a Java tool to interpolate settings from a list of images in format DNG,](https://github.com/victor-porcar/TimelapseDNGInterpolator2)
    * [victor-porcar/Bookmark2md](https://github.com/victor-porcar/Bookmark2md)
    * [victor-porcar/victor-porcar.github.private](https://github.com/victor-porcar/victor-porcar.github.private)
    * ## forked

      * [victor-porcar/Full-stack-Developer-Interview-Questions-and-Answers: :grey_question:Full-stack developer interview questions and answers](https://github.com/victor-porcar/Full-stack-Developer-Interview-Questions-and-Answers)
      * [victor-porcar/effective-java-summary: A personnal summary of the book Effective Java by Joshua Bloch](https://github.com/victor-porcar/effective-java-summary)
